...
TECKNO.listenerMenu = function(){
	$('#mobile-nav').on('click', function(e){
		...
		$("#menu, body, header").toggleClass('open');
		e.preventDefault();
	});

	$('#menu-nav a, #menu-nav-mobile a').on('click', function(){
		$('#mobile-nav,#menu, body, header').removeClass('open');
	});
}
...
TECKNO.slider = function(){
	$.supersized({
		...
		slides 					:  	[			// Slideshow Images
											{image : '_include/img/slider-images/slide1.jpg', title : '', thumb : '', url : ''},
											{image : '_include/img/slider-images/slide2.jpg', title : '', thumb : '', url : ''},
											{image : '_include/img/slider-images/slide3.jpg', title : '', thumb : '', url : ''},
											{image : '_include/img/slider-images/slide4.jpg', title : '', thumb : '', url : ''}
									],
		//
		// // Theme Options
		...
		swipe:function(event, direction, distance, duration, fingerCount, fingerData) {
		  if ( direction == "left") {
			...
			api.prevSlide();
		  	...
		  	$("#home-slider .nextsection").trigger("click");
		  }
		  else {
		  	$('#goUp').trigger("click");
		  }
...
//
// 	//company section
// 	$('#company-build').waypoint({
// 		handler: function(direction) {
// 	    	// do stuff
// 	    	$(".x-company-build").addClass("animated");
//   		},
//   		offset: 100
// 	});
// 	//company section
...
// 		handler: function(direction) {
// 	    	// do stuff
// 	    	$(".x-company-values").addClass("animated");
//   		},
//   		offset: 50
// 	});
// }
...
/* ==================================================
   Next Section
================================================== */
TECKNO.goSection = function(){
	$('.nextsection').on('click', function(){
		$target = $($(this).attr('href')).offset().top;
		$('body, html').animate({scrollTop : $target}, 600, 'easeOutExpo');
		return false;
	});
}
...
/* ==================================================
	Scroll to Top
================================================== */
TECKNO.scrollToNextPage = function(){
	...
	$arrow.click(function(e) {
		$('body,html').animate({ scrollTop: "0" }, 600, 'easeOutExpo' );
		e.preventDefault();
	})
...
TECKNO.utils = function(){
	$('.item-thumbs, .box-value, .capabilities-box, #social ul li a').bind('touchstart', function(){
		...
		if ( width < 767 ) {
			...
			$(window).scroll(function() {
			  ...
			  if (scroll > position) {
			    ...
			    $('header .sticky-nav.stuck').css("position","relative");
			  } else {
			     // scrolling Up
			     console.log("scroll Up");
			     $('header .sticky-nav.stuck').css("position","fixed");
			  }
			  position = scroll;
			});
		}
